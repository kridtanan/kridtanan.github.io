...
infospot5.position.set(4952.12, -477.31, -427.46);
infospot5.addHoverElement( panel5, 500 );

/* ผลิตภัณฑ์ */
infospot6 = new PANOLENS.Infospot( 350, PANOLENS.DataImage.Info );
infospot6.position.set(4106.54, -697.45, 2749.82);
